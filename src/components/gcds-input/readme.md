...
| `inputHint`    | `input-hint`    | Hint displayed below the label and above the input field. | `string`                                                           | `undefined` |
| `inputId`      | `input-id`      | Id + name attribute for an input element.                 | `string`                                                           | `undefined` |
| `inputValue`   | `input-value`   | Default value for an input element.                       | `number \| string`                                                 | `undefined` |
