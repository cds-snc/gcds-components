...
| `buttonStyle`           | `button-style`            | Set the style variant                                                                                                                              | `"outline" \| "solid" \| "text-only"`                            | `undefined` |
| `buttonType`            | `button-type`             | Set button types                                                                                                                                   | `"button" \| "link" \| "reset" \| "submit"`                      | `undefined` |
...
| `interactionState`      | `interaction-state`       | Set component states                                                                                                                               | `"active" \| "default" \| "disabled" \| "focus" \| "hover"`      | `undefined` |
