...
| ----------------------- | ------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------- | ----------- |
| `buttonRole`            | `button-role`             | Set the main style                                                                                                                                 | `"danger" \| "primary" \| "secondary" \| "skip-to-content"` | `'primary'` |
...
| `interactionState`      | `interaction-state`       | Set component states                                                                                                                               | `"active" \| "default" \| "disabled" \| "focus" \| "hover"` | `'default'` |
