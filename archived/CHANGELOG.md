...
## [0.47.0](https://github.com/cds-snc/gcds-components/compare/gcds-components-v0.46.0...gcds-components-v0.47.0)
...
All form components now have access to the `checkValidity()` method.
