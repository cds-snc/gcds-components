...
|------------------------------------------------------| ----------------------------------------------------------------------------------- | ---------------- |
| [@gcds-core/components](packages/web/)          | GC Design System Components | [Docs](packages/web/README.md) |
| [@gcds-core/components-react](packages/react/)     | GC Design System Components – React | [Docs](packages/react/README.md) |
| [@gcds-core/components-angular](packages/angular/) | GC Design System Components – Angular  | [Docs](packages/angular/README.md) |
| [@gcds-core/components-vue](packages/vue/)         | GC Design System Components – Vue  | [Docs](packages/vue/README.md) |
...
| ------------------------- | ----------------------------------------------------------------------------------- | ---------------- |
| [@gcds-core/components](packages/web/)           | Composants de Système de design GC | [Docs](packages/web/README.md) |
| [@gcds-core/components-react](packages/react/)           | Composants de Système de design GC — React | [Docs](packages/react/README.md) |
| [@gcds-core/components-angular](packages/angular/)           | Composants de Système de design GC — Angular  | [Docs](packages/angular/README.md) |
| [@gcds-core/components-vue](packages/vue/)           | Composants de Système de design GC — Vue  | [Docs](packages/vue/README.md) |
