      ...
      <gcds-select select-id="select" label="select" name="select-name">
        <mock:shadow-root>
          <div class="gcds-select-wrapper">
            ...
            <select id="select" name="select-name" part="input" aria-invalid="false">
            </select>
          </div>
        </mock:shadow-root>
      </gcds-select>
      ...
      <gcds-select select-id="select" label="select" name="select-name" disabled error-message="">
        <mock:shadow-root>
          <div class="gcds-select-wrapper gcds-disabled">
            <gcds-label label="select" label-for="select" lang="en"></gcds-label>
            <select id="select" name="select-name" part="input" aria-invalid="false" disabled>
            </select>
          </div>
        </mock:shadow-root>
      </gcds-select>
      ...
      <gcds-select select-id="select" label="select" name="select-name" error-message="This is an error message.">
        <mock:shadow-root>
          <div class="gcds-select-wrapper gcds-error">
            ...
            <select id="select" name="select-name" part="input" aria-invalid="true" aria-describedby="error-message-select ">
            </select>
          </div>
        </mock:shadow-root>
      </gcds-select>
      ...
      <gcds-select select-id="select" label="select" name="select-name" hint="This is a hint.">
        <mock:shadow-root>
          <div class="gcds-select-wrapper">
            ...
            <select id="select" name="select-name" part="input" aria-invalid="false" aria-describedby="hint-select ">
            </select>
          </div>
        </mock:shadow-root>
      </gcds-select>
      ...
      <gcds-select select-id="select" label="select" name="select-name" required>
        <mock:shadow-root>
          <div class="gcds-select-wrapper">
            ...
            <select id="select" name="select-name" part="input" aria-invalid="false" required="">
            </select>
          </div>
        </mock:shadow-root>
      </gcds-select>
    ...
    expect(page.root).toEqualHtml(`
      <gcds-select select-id="select" name="select" label="select" default-value="Please select one">
        <mock:shadow-root>
          <div class="gcds-select-wrapper">
            <gcds-label label="select" label-for="select" lang="en"></gcds-label>
            <select id="select" name="select" part="input" aria-invalid="false">
