      ...
      <gcds-date-input format="full" legend="Date input" name="date">
        <mock:shadow-root>
          <fieldset aria-labelledby="date-input-legend" class="gcds-date-input__fieldset" tabindex="-1">
            ...
            <gcds-input aria-invalid="false" class="gcds-date-input__day" inputid="day" label="Day" name="day" size="2" type="number" inputmode="numeric" value=""></gcds-input>
            <gcds-input aria-invalid="false" class="gcds-date-input__year" inputid="year" label="Year" name="year" size="4" type="number" inputmode="numeric" value=""></gcds-input>
          </fieldset>
        </gcds-date-input>
    `);
  });
      ...
      <gcds-date-input format="full" lang="fr" legend="Date input" name="date">
        <mock:shadow-root>
          <fieldset aria-labelledby="date-input-legend" class="gcds-date-input__fieldset" tabindex="-1">
            ...
            <gcds-input aria-invalid="false" class="gcds-date-input__day" inputid="day" label="Jour" name="day" size="2" type="number" inputmode="numeric" value=""></gcds-input>
            ...
            <gcds-input aria-invalid="false" class="gcds-date-input__year" inputid="year" label="Année" name="year" size="4" type="number" inputmode="numeric" value=""></gcds-input>
          </fieldset>
        </mock:shadow-root>
      </gcds-date-input>
    `);
      ...
      <gcds-date-input format="full" legend="Date input" name="date" required>
        <mock:shadow-root>
          <fieldset aria-labelledby="date-input-legend" class="gcds-date-input__fieldset" tabindex="-1">
            ...
            <gcds-input aria-invalid="false" aria-required="true" class="gcds-date-input__day" inputid="day" label="Day" name="day" size="2" type="number" inputmode="numeric" value=""></gcds-input>
            <gcds-input aria-invalid="false" aria-required="true" class="gcds-date-input__year" inputid="year" label="Year" name="year" size="4" type="number" inputmode="numeric" value=""></gcds-input>
          </fieldset>
        </gcds-date-input>
    `);
  });
      ...
      <gcds-date-input format="full" legend="Date input" name="date" value="1991-03-15">
        <mock:shadow-root>
          <fieldset aria-labelledby="date-input-legend" class="gcds-date-input__fieldset" tabindex="-1">
            ...
            <gcds-input aria-invalid="false" class="gcds-date-input__day" inputid="day" label="Day" name="day" size="2" type="number" inputmode="numeric" value="15"></gcds-input>
            <gcds-input aria-invalid="false" class="gcds-date-input__year" inputid="year" label="Year" name="year" size="4" type="number" inputmode="numeric" value="1991"></gcds-input>
          </fieldset>
        </gcds-date-input>
    `);
  });
      ...
      <gcds-date-input format="full" legend="Date input" name="date" value="1991-03-015">
        <mock:shadow-root>
          <fieldset aria-labelledby="date-input-legend" class="gcds-date-input__fieldset" tabindex="-1">
            ...
            <gcds-input aria-invalid="false" class="gcds-date-input__day" inputid="day" label="Day" name="day" size="2" type="number" inputmode="numeric" value="015"></gcds-input>
            <gcds-input aria-invalid="false" class="gcds-date-input__year" inputid="year" label="Year" name="year" size="4" type="number" inputmode="numeric" value="1991"></gcds-input>
          </fieldset>
        </mock:shadow-root>
      </gcds-date-input>
      ...
      <gcds-date-input format="full" legend="Date input" name="date" value="222f-23-red">
        <mock:shadow-root>
          <fieldset aria-labelledby="date-input-legend" class="gcds-date-input__fieldset" tabindex="-1">
            ...
            <gcds-input aria-invalid="false" class="gcds-date-input__day" inputid="day" label="Day" name="day" size="2" type="number" inputmode="numeric" value="red"></gcds-input>
            <gcds-input aria-invalid="false" class="gcds-date-input__year" inputid="year" label="Year" name="year" size="4" type="number" inputmode="numeric" value="222f"></gcds-input>
          </fieldset>
        </gcds-date-input>
    `);
  });
