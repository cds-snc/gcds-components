...
describe('gcds-button', () => {
  it('renders with no passed properties', async () => {
    ...
    expect(root).toEqualHtml(`
      <gcds-button>
        <mock:shadow-root>
          <button class="button--regular button--role-primary" part="button" type="button">
            <slot></slot>
          </button>
        </mock:shadow-root>
        Button Label
  ...
  it('renders type button', async () => {
    ...
    expect(root).toEqualHtml(`
      <gcds-button type="button">
        <mock:shadow-root>
          <button class="button--role-primary button--regular" part="button" type="button">
            <slot></slot>
          </button>
        </mock:shadow-root>
        Button Label
  ...
  it('renders type reset', async () => {
    ...
    expect(root).toEqualHtml(`
      <gcds-button type="reset">
        <mock:shadow-root>
          <button class="button--role-primary button--regular" part="button" type="reset">
            <slot></slot>
          </button>
        </mock:shadow-root>
        Button Label
  ...
  it('renders type submit', async () => {
    ...
    expect(root).toEqualHtml(`
      <gcds-button type="submit">
        <mock:shadow-root>
          <button class="button--role-primary button--regular" part="button" type="submit">
            <slot></slot>
          </button>
        </mock:shadow-root>
        Button Label
  ...
  it('renders type link', async () => {
    ...
    expect(root).toEqualHtml(`
      <gcds-button href="#" type="link">
        <mock:shadow-root>
          <a class="button--role-primary button--regular" part="button" href="#">
            <slot></slot>
          </a>
        </mock:shadow-root>
        Link Label
  ...
  it('renders button-role secondary', async () => {
    ...
    expect(root).toEqualHtml(`
      <gcds-button button-role="secondary">
        <mock:shadow-root>
          <button class="button--role-secondary button--regular" part="button" type="button">
            <slot></slot>
          </button>
        </mock:shadow-root>
        Button Label
  ...
  it('renders button-role danger', async () => {
    ...
    expect(root).toEqualHtml(`
      <gcds-button button-role="danger">
        <mock:shadow-root>
          <button class="button--role-danger button--regular" part="button" type="button">
            <slot></slot>
          </button>
        </mock:shadow-root>
        Button Label
  ...
  it('renders external link with label + icon', async () => {
    const { root } = await newSpecPage({
      components: [GcdsButton],
      html: `<gcds-button type="link" href="https://google.com" target="_blank">Button Label</gcds-button>`,
    });
    expect(root).toEqualHtml(`
      <gcds-button type="link" href="https://google.com" target="_blank">
        <mock:shadow-root>
          <a class="button--role-primary button--regular" href="https://google.com" part="button" target="_blank">
            <slot></slot>
