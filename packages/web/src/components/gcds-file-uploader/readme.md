...
| `validator`               | --              | Array of validators                                                                                                             | `(string \| ValidatorEntry \| Validator<string \| number \| FileList>)[]` | `undefined` |
| `validity`                | --              | Read-only property of the file uploader, returns a ValidityState object that represents the validity states this element is in. | `ValidityState`                                                           | `undefined` |
