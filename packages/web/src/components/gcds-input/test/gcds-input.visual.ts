...
test.describe('gcds-input', () => {
  ...
  test('readonly', async ({ page }) => {
    await expect(
      page.locator('[data-variant="readonly"] .preview-component'),
    ).toHaveScreenshot('readonly.png');
  });
  ...
  test('size', async ({ page }) => {
    await expect(
      page.locator('[data-variant="size"] .preview-component'),
    ).toHaveScreenshot('size.png');
  });
