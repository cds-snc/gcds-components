...
| `cardTitleTag`           | `card-title-tag` | The card title tag defines the HTML element used for the title. While the font size remains the same regardless of the tag, it’s important for accessibility to set the correct heading level to maintain a proper heading hierarchy on the page. | `"a" \| "h3" \| "h4" \| "h5" \| "h6"` | `'a'`       |
