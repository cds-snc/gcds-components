...
export const GcdsMenuGroup = /*@__PURE__*/createReactComponent<JSX.GcdsMenuGroup, HTMLGcdsMenuGroupElement>('gcds-menu-group');
export const GcdsMenuLink = /*@__PURE__*/createReactComponent<JSX.GcdsMenuLink, HTMLGcdsMenuLinkElement>('gcds-menu-link');
