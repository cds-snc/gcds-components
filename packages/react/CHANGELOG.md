...
## [0.30.0-canary.0](https://github.com/cds-snc/gcds-components/compare/gcds-components-react-v0.29.0...gcds-components-react-v0.30.0-canary.0) (2024-12-11)
...
* The following workspace dependencies were updated
  * dependencies
    * @cdssnc/gcds-components bumped from ^0.29.0 to ^0.30.0-canary.0
