...
## [0.35.0-canary.0](https://github.com/cds-snc/gcds-components/compare/gcds-components-react-v0.34.0...gcds-components-react-v0.35.0-canary.0) (2025-04-16)
...
* The following workspace dependencies were updated
  * dependencies
    * @cdssnc/gcds-components bumped from ^0.34.0 to ^0.35.0-canary.0
