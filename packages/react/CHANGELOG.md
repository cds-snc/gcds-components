...
## [0.27.0-canary.0](https://github.com/cds-snc/gcds-components/compare/gcds-components-react-v0.26.3...gcds-components-react-v0.27.0-canary.0) (2024-10-16)
...
* The following workspace dependencies were updated
  * dependencies
    * @cdssnc/gcds-components bumped from ^0.26.3 to ^0.27.0-canary.0
