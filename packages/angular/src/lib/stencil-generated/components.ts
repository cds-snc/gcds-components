...
@ProxyCmp({
  inputs: ['buttonId', 'buttonRole', 'disabled', 'download', 'external', 'href', 'name', 'rel', 'size', 'target', 'type', 'value'],
...
@Component({
  ...
  template: '<ng-content></ng-content>',
  // eslint-disable-next-line @angular-eslint/no-inputs-metadata-property
  inputs: ['buttonId', 'buttonRole', 'disabled', 'download', 'external', 'href', 'name', 'rel', 'size', 'target', 'type', 'value'],outputs: ['gcdsClick', 'gcdsFocus', 'gcdsBlur'],
})
