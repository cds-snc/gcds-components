...
## [0.34.4](https://github.com/cds-snc/gcds-components/compare/gcds-components-angular-v0.34.3...gcds-components-angular-v0.34.4) (2025-05-28)
...
* The following workspace dependencies were updated
  * peerDependencies
    * @cdssnc/gcds-components bumped from ^0.34.3 to ^0.34.4
