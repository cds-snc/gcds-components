...
## [1.3.2](https://github.com/cds-snc/gcds-components/compare/@gcds-core/components-angular-v1.3.1...@gcds-core/components-angular-v1.3.2) (2026-06-30)
...
* The following workspace dependencies were updated
  * peerDependencies
    * @gcds-core/components bumped from ^1.3.1 to ^1.3.2
