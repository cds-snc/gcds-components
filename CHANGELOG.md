...
## [1.6.0](https://github.com/cds-snc/gcds-components/compare/@gcds-core/components-v1.5.0...@gcds-core/components-v1.6.0)
...
Version publiée le : 2026-09-08

### Nouvelles fonctionnalités

* **gcds-card&nbsp;:** **_Nouvel_** emplacement `title` pour prendre en charge le contenu riche et améliorer la lecture des titres de carte à voix haute sur Android et iOS. ([#1380](https://github.com/cds-snc/gcds-components/issues/1380)) ([747d289](https://github.com/cds-snc/gcds-components/commit/747d289a9dda9ee1a8c38537e433b117091f675a))
* **gcds-date-input&nbsp;:** Prise en charge de la propriété `autocomplete` (saisie semi-automatique) ([#1299](https://github.com/cds-snc/gcds-components/issues/1299)) ([ab00260](https://github.com/cds-snc/gcds-components/commit/ab002601e99497eea8667860bb7ceb1c11e959dc))

### :bug: :wrench: Corrections de bogues

* **gcds-alert :** Les alertes de réussite et d’information ajoutées dynamiquement sont maintenant annoncées par les lecteurs d’écran. ([#1393](https://github.com/cds-snc/gcds-components/issues/1393)) ([d6a4701](https://github.com/cds-snc/gcds-components/commit/d6a4701ad3439c89393aa687ccde6e4f872c387a))
* **gcds-file-uploader&nbsp;:** Le curseur du clavier reste ancré dans le téléverseur de fichiers lorsqu’un fichier est supprimé ([#1407](https://github.com/cds-snc/gcds-components/issues/1407)) ([a99f7a0](https://github.com/cds-snc/gcds-components/commit/a99f7a030a1860115d2da9f2621cd18d8efbe083))
* **gcds-header&nbsp;:** Amélioration de la disposition des emplacements et du style réactif de la propriété `account` sur les portables, les tablettes et les ordinateurs de bureau ([#1394](https://github.com/cds-snc/gcds-components/issues/1394)) ([9ce7927](https://github.com/cds-snc/gcds-components/commit/9ce79274f91d91a4dfad4670cf10f9a4b3560bfa))
...
* **gcds-signature :** Ajustement de la taille de la signature afin de s’aligner avec les critères du Programme de coordination de l’image de marque ([#1346](https://github.com/cds-snc/gcds-components/issues/1346)) ([1725b29](https://github.com/cds-snc/gcds-components/commit/1725b299060121bf6cc3042713c5b0c810cfd0ad))
...
* **gcds-table&nbsp;:** 
  ...
  * La boîte de dialogue de filtres ne se ferme plus lorsque la touche de retour est appuyée ([#1320](https://github.com/cds-snc/gcds-components/issues/1320)) ([7607e62](https://github.com/cds-snc/gcds-components/commit/7607e62d195ea6586de7775f9f8b8593dd0efe5b))
